...
with mp_pose.Pose(min_detection_confidence=0.5, min_tracking_confidence=0.5) as pose:
    while cap.isOpened():
        ...
        try:
            ...
            # counter logic
            if angle < 90:  # down angle gives some leeway so the connection doesnt have to be exactl 180 to be counted as down
                stage = "down"
        ...
        mp_drawing.draw_landmarks(
            ...
            mp_drawing.DrawingSpec(color=(254, 120, 106),
                                   thickness=2, circle_radius=2),  # styles the different lines within the model in BRG
            mp_drawing.DrawingSpec(color=(254, 197, 106),
                                   thickness=2, circle_radius=2))  # styles the different lines within the modelin BGR
