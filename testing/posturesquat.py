    ...
    while cap.isOpened():
        ...
        try:
            ...
            if angle < 30:
                ...
                depth_color = (255, 255, 0)  # Yellow

            elif angle > 150:  # UP position
                if stage == "DOWN":
            ...
            cv2.putText(image, depth_status, (300, 20), cv2.FONT_HERSHEY_SIMPLEX,
                        1, (depth_color), 1, cv2.LINE_AA)
